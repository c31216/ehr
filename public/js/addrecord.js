$(document).ready(function(){
	...
	addrecord.click(function(e){
		e.preventDefault();
		status = 1;
		$("#p_list").prepend('<tr id="active"><td><input type="text" id="daterange" name="registration_date" value="'+output+'" data-toggle="datepicker" class="col-xs-12 docs-date" ></input></td>'+
